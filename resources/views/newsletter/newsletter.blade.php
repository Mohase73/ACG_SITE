...
@section('content')
<h2 class="text-center">Souscrivez vous à notre newsletter</h2>
<div class="container">
...
@endif
	...
	<div class="row">
		<div class="col-md-5">
			<div class="well">
	             {!! Form::open(array('route' => 'subscribe')) !!}
	              <div>
	              	<h3 class="text-center">SOuscrivez votre Email</h3>
	                 <input class="form-control" name="email" id="email" type="email" placeholder="Your Email" required>
	                 <br/>
	                 <div class="text-center">
	                 	<button class="btn btn-info btn-lg" type="submit">Souscrire</button>
	                 </div>
	              </div>
	             {!! Form::close() !!}
	    	 </div>
		...
		<div class="col-md-7">
          ...
          <fieldset>
            <legend class="text-center">Envoyer campagne</legend>
            ...
            <!-- Email input-->
            <div class="form-group">
              <label class="col-md-3 control-label" for="email">A</label>
              <div class="col-md-9">
            ...
            <!-- From Email input-->
            <div class="form-group">
              <label class="col-md-3 control-label" for="email">De</label>
              <div class="col-md-9">
            ...
            <div class="form-group">
              <div class="col-md-12 text-right">
                <button type="submit" class="btn btn-primary btn-lg">Envoyer campagne</button>
              </div>
            </div>
          </fieldset>
          {!! Form::close() !!}
