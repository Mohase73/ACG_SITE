                    ...
                    <div class="container-fluid">
                        <div class="d-flex">
                            <a class="header-brand d-md-none" href="{{url('/' . $page='index')}}">
                                <img src="{{URL::asset('assets/logo3.png')}}" alt="logo" class="img-fluid header-brand-img mobile-icon">
                                <img src="{{URL::asset('assets/logo3.png')}}" alt="logo" class="img-fluid header-brand-img desktop-logo mobile-logo">
                            </a>
                                ...
                                <div class="dropdown profile-1">
                                    <a href="#" data-toggle="dropdown" class="nav-link pl-2 pr-2  leading-none d-flex">
                                        <span>
                                            ...
                                            <img src="{{asset('storage/'. Auth::user()- class="img-fluid">profile_photo_path)}}" alt="profile-user" class="avatar  mr-xl-3 profile-user brround cover-image">
                                        </span>
