...
<head>
    ...
    <title>Fullscreen Home &#8211; Burst</title>
    ...
    <link rel='stylesheet' id='rabbit_css-css'
        ...
        media='all' />
    <link rel="stylesheet" href="/wp-content/cache/minify/b9abc.css" media="all" />
...
<![endif]-->
    ...
    <script type='text/javascript'>
        ...
        var wc_add_to_cart_params = {
            ...
            "wc_ajax_url": "\/burst\/fullscreen-home\/?wc-ajax=%%endpoint%%",
    ...
    <link rel="canonical" href="/fullscreen-home/" />
    <link rel='shortlink' href='/?p=5134' />
    <link rel="alternate" type="application/json+oembed"
        href="/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fburst.qodeinteractive.com%2Fburst%2Ffullscreen-home%2F" />
    <link rel="alternate" type="text/xml+oembed"
        href="/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fburst.qodeinteractive.com%2Fburst%2Ffullscreen-home%2F&#038;format=xml" />
    ...
    <link rel="stylesheet" href="/wp-content/fa/css/fa.min.css">
...
<body class="page-template page-template-full_screen page-template-full_screen-php page page-id-5134 mkd-core-1.0 ajax_fade page_not_loaded  burst-ver-1.0  vertical_menu_with_scroll smooth_scroll woocommerce_installed blog_installed wpb-js-composer js-comp-ver-6.0.5 vc_responsive">
    ...
    <div class="wrapper">
        <div class="wrapper_inner">
            ...
            <div class="content content_top_margin_none has_slider">
                <div class="meta">
                    <div class="seo_title">Burst | Fullscreen Home</div>
                    <span id="mkd_page_id">5134</span>
                    <div class="body_classes">
                        page-template,page-template-full_screen,page-template-full_screen-php,page,page-id-5134,mkd-core-1.0,ajax_fade,page_not_loaded,,burst-ver-1.0,
                        vertical_menu_with_scroll,smooth_scroll,woocommerce_installed,blog_installed,wpb-js-composer
                        js-comp-ver-6.0.5,vc_responsive</div>
                </div>
                <div class="content_inner  ">
                    ...
                    <div class="full_screen_holder hide_navigation">
                        <div class="full_screen_inner" style="padding-top:0px !important">
                            @yield('content')
                        ...
                        <div class="full_screen_navigation_holder">
                            <div class="full_screen_navigation_inner">
                                ...
                                <a id="down_fs_button" href="#" target="_self"><span
    ...
    <div class="rbt-toolbar" data-theme="Burst" data-featured="" data-button-position="25%"
    ...
    <script type='text/javascript'
        src='https://export.qodethemes.com/_toolbar/assets/js/rbt-modules.js?ver=5.2.2'></script>
