        ...
        <div class="container">
            <div class="col-12 text-center">
                <h2 class="special-heading underline text-dark">
                    <span>Nous développons des solutions numériques</span>
                </h2>
                        ...
                        <div>
                            <div class="col-12 text-center">
                                <p class=" text-center text-left">
                                    <span>Nous facturons les sites en fonction de la demande du client sa complexité, son contenu, les technologies exigées.</span>
                                </p>
                                <div class="divider-55 hidden-below-lg"></div>
                                <div class="divider-40 hidden-above-lg"></div>
                                <div class="divider-60 hidden-below-lg"></div>
